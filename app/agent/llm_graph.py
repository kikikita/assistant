...
SYSTEM_PROMPT = (
    ...
    "Форматируй ответ красиво, с использованием markdown (Legacy, который поддерживается в телеграм). Используй нумерацию списков и последовательности действий (вместо '*' используй '-')."
